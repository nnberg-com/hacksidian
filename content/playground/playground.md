...
[[atlas/! categories/palette|Палитры]] · [[playground/palette|Проверка палитры]]

## Эта статья показывает по одному простому примеру каждой базовой возможности Markdown, которая заметна в Obsidian Reading view.
...
Подробнее: [[p002|Структура и типографика длинной статьи]]

### Ссылки и изображение

Внутренняя ссылка ведёт к [[p001|другой заметке]], а внешняя — к [справке Obsidian](https://obsidian.md/help). Рядом может встретиться #локальный-тег, который должен быть заметен, но не обязан перетягивать всё внимание.

![Схематическое поле чтения](assets/pole-chteniya.svg)

Подробнее: [[p003|Ссылки и изображения в длинной статье]]
...
Подробнее: [[p004|Цитаты в длинной статье]]
...
Подробнее: [[p005|Списки и задачи в длинной статье]]
...
Подробнее: [[p006|Таблицы в длинной статье]]
...
Подробнее: [[p007|Код в длинном тексте]]
...
Подробнее: [[p008|Диаграммы Mermaid в тексте]]
...
Подробнее: [[p009|Выноски в длинной статье]]
...
Подробнее: [[p010|Формулы и сноски в длинной статье]]
