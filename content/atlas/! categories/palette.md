...
12 источников · 26 вариантов. Все светлые и тёмные варианты показаны ниже, по семействам. Каждый образец показывает фоны, текст, выделения, состояния и восемь цветов Obsidian.
