...
tags:
  ...
  - hacksidian_iframe
title: Просто аккуратный iframe
category: iframe
sources: []
format: html
themes: []
...
```hacksidian-details
> Зачем
Карты и виджеты в обычной статье.

> Как работает
Блочный элемент не оставляет строчный зазор; width заполняет колонку, border убирает рамку.
