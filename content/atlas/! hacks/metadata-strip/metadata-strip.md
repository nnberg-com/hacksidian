...
```hacksidian-details
> Зачем
Отделить служебную часть одной линией, оставив воздух вокруг текста.

> Как работает
У контейнера только нижняя граница; заголовок Properties уменьшен и разрежен.
