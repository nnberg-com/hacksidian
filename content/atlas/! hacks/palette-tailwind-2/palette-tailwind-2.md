...
tags:
  ...
  - hacksidian_palette
title: "Tailwind CSS — Slate + Indigo · Dark"
category: palette
sources:
...
> Как работает
Наша сборка Slate + Indigo; роли и ступени выбраны нами. Точные OKLCH из установленного Tailwind, без загрузки Tailwind в пример.
