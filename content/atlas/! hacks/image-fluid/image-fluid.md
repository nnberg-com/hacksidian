...
tags:
  ...
  - hacksidian_image
title: Изображение в пределах заметки
category: image
sources:
...
> Как работает
max-inline-size:100% уменьшает слишком широкое изображение до ширины колонки. Маленькое изображение не растягивается. height:auto сохраняет пропорции без обрезки; display:block убирает зазор текстовой строки. Дополнительно скругляются углы. Если тема уже ограничивает ширину изображений, разница может быть почти незаметна.
```
