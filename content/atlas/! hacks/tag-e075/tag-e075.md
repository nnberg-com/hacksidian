...
```hacksidian-details
> Зачем
Экономный и читаемый бумажный вывод.

> Как работает
Медиаправило заменяет заливку простой линией при печати.

> Ограничения
Эффект виден в предпросмотре печати браузера.
```
