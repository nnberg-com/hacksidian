...
> Как работает
ul с изображениями превращается в сетку из трёх колонок. Все кадры квадратные: aspect-ratio: 1 и object-fit: cover сохраняют пропорции исходника, но обрезают лишнее по центру. У горизонтальной картинки обрезаются боковые части, у вертикальной — верх и низ; растяжения и пустых полос нет.
