...
```hacksidian-details
> Зачем
Длинное имя в узкой колонке.

> Как работает
Каждый фрагмент одной ссылки при переносе получает края и отступы.

> Ограничения
Это перенос одной ссылки, не склейка отдельных span CodeMirror.
```
