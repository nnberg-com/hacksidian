...
```hacksidian-details
> Зачем
Одноцветная системная пиктограмма без HTML-картинки.

> Как работает
SVG используется только как CSS-маска, цвет берётся из currentColor.
```
