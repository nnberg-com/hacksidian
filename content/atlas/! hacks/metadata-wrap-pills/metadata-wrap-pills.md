...
tags:
  ...
  - hacksidian_metadata
title: Плашки в несколько строк
category: metadata
sources:
...
```hacksidian-details
> Зачем
Показать весь набор тегов без горизонтального скролла.

> Как работает
Flex-wrap у списка, min-width: 0 у плашки и переносы внутри длинного названия.
