...
title: Аварийный перенос длинного пути
...
```hacksidian-details
> Зачем
Чтобы длинный идентификатор не расширял колонку.

> Как работает
overflow-wrap:anywhere разрешает разрыв, если фрагмент иначе не помещается; дефис не добавляется.
```
