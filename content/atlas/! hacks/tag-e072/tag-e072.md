...
tags:
  ...
  - hacksidian_tag
title: Неразрывная короткая метка
category: tag
sources: []
format: markdown
themes: []
...
```hacksidian-details
> Зачем
Короткие категории, которые не стоит разрывать.

> Как работает
inline-block переносится целиком.

> Ограничения
Для очень длинных тегов используйте переносимый вариант выше.
```
