...
tags:
  ...
  - hacksidian_palette
title: "Material — Seed 6750A4 · Dark"
category: palette
sources:
...
> Как работает
Наша фиксированная сборка: seed #6750A4, themeFromSourceColor. Восемь цветных ролей дополнены отдельными tonal palettes; не канонический набор Material.
