...
tags:
  ...
  - hacksidian_tag
title: Длинный тег с многоточием
category: tag
sources: []
format: markdown
themes: []
...
```hacksidian-details
> Зачем
Сжатые списки с возможностью раскрыть полное имя.

> Как работает
Ограничение ширины снимается при наведении и фокусе.

> Ограничения
Раскрытие может менять высоту строки; на сенсорном экране hover ненадёжен.
```
