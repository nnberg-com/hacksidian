...
[[atlas/! themes/pink-topaz|Pink Topaz]] · [Репозиторий на момент проверки](https://github.com/shaggyfeng/obsidian-Pink-topaz-theme/tree/4d260d1181027e9475d790a801b940ff686ced16)

Commit: `4d260d1181027e9475d790a801b940ff686ced16`. Основной файл: `obsidian.css`. Текстовых файлов в инвентаризации: 2; документов: 1; CSS-файлов: 1; правил основного CSS разобрано: 619.

## Результат сопоставления

Новых карточек: 2; ранее существовавших приёмов с найденными подтверждениями: 16.
...
- [README.md](https://github.com/shaggyfeng/obsidian-Pink-topaz-theme/tree/4d260d1181027e9475d790a801b940ff686ced16/README.md) — Download; Change log; Features & Screenshots; Aesthetic matters! This is the first all-pink obsidian theme; Colours support all charts and tables and blocks and tags etc from core and plug-ins. Interactive hover for outlines and charts etc all have hand-picked colours; Wherever you edit, a pink field will help you focus(the line above "- asga" is highlighted in light pink); Quotes and embeddings look nice in pink; Hand picked colours for code and syntax ; Dark mode has all the features, just sexier
