...
- [[atlas/! hacks/unordered-e013/unordered-e013|Без видимых маркеров]] — существующая карточка
...
| Bullet Style | `CG-bullet-style` | Есть карточка | Механизм уже описан в каталоге; добавлено подтверждение для этой темы. [[atlas/! hacks/unordered-markers/unordered-markers\|Цвет и форма маркеров]] | [код](https://github.com/thepharaohart/Obsidian-CyberGlow/blob/a9a9776d5cb68ce09bec36e29f1084da6757f6db/theme.css#L270) |
...
| Disable Bullets in Callout | `CG-bulletcallout` | Есть карточка | Механизм уже описан в каталоге; добавлено подтверждение для этой темы. [[atlas/! hacks/unordered-e013/unordered-e013\|Без видимых маркеров]] | [код](https://github.com/thepharaohart/Obsidian-CyberGlow/blob/a9a9776d5cb68ce09bec36e29f1084da6757f6db/theme.css#L307) |
...
| Heading Dividing Line (---) | `CG-hr` | Есть карточка | Подтверждено правилом CSS. [[atlas/! hacks/hr-ornament/hr-ornament\|Орнамент вместо горизонтальной черты]] | [код](https://github.com/thepharaohart/Obsidian-CyberGlow/blob/a9a9776d5cb68ce09bec36e29f1084da6757f6db/theme.css#L355) |
