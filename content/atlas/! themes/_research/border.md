...
- [[atlas/! hacks/interface-focused-pane/interface-focused-pane|Рамка панели с фокусом]] — существующая карточка
...
| Auto hide header icons in sidepane | `nav-header-autohide` | Есть карточка | Подтверждено правилом CSS. [[atlas/! hacks/interface-quiet-actions/interface-quiet-actions\|Тихая панель действий]] | [код](https://github.com/akifyss/obsidian-border/blob/05d2df5d157e15f13be1a43da2d3034c995dd8e2/theme.css#L45) |
...
| Remove additional added animation | `extra-anim-remove` | Есть карточка | Подтверждено правилом CSS. [[atlas/! hacks/meta-reduced-motion/meta-reduced-motion\|Уважать уменьшение движения]] | [код](https://github.com/akifyss/obsidian-border/blob/05d2df5d157e15f13be1a43da2d3034c995dd8e2/theme.css#L281) |
...
| Highlight active card | `card-highlight-light` | Есть карточка | Механизм уже описан в каталоге; добавлено подтверждение для этой темы. [[atlas/! hacks/interface-focused-pane/interface-focused-pane\|Рамка панели с фокусом]] | [код](https://github.com/akifyss/obsidian-border/blob/05d2df5d157e15f13be1a43da2d3034c995dd8e2/theme.css#L1241) |
...
| Highlight active card | `card-highlight-dark` | Есть карточка | Механизм уже описан в каталоге; добавлено подтверждение для этой темы. [[atlas/! hacks/interface-focused-pane/interface-focused-pane\|Рамка панели с фокусом]] | [код](https://github.com/akifyss/obsidian-border/blob/05d2df5d157e15f13be1a43da2d3034c995dd8e2/theme.css#L2198) |
...
| Enable grid background pattern | `editor-grid-background-pattren` | Есть карточка | Подтверждено правилом CSS. [[atlas/! hacks/note-dotted/note-dotted\|Заметка на точечной сетке]] | [код](https://github.com/akifyss/obsidian-border/blob/05d2df5d157e15f13be1a43da2d3034c995dd8e2/theme.css#L2316) |
...
| Restore default style of unordered list | `ul-marker-restore` | Есть карточка | Механизм уже описан в каталоге; добавлено подтверждение для этой темы. [[atlas/! hacks/note-list-markers/note-list-markers\|Цвет и форма маркеров]] | [код](https://github.com/akifyss/obsidian-border/blob/05d2df5d157e15f13be1a43da2d3034c995dd8e2/theme.css#L3080) |
