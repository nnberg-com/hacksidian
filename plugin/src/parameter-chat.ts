...
If the request is to find or recommend another technique, or clearly concerns a different element/technique than the current card, return search_catalog with empty changes. Otherwise stay on this technique. If no listed parameter can implement the request, explain the limitation with no_change, never invent an adjustment. An empty parameters list means this card has no adjustable fields.
